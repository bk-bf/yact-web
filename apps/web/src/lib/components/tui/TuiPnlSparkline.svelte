...
<TuiPanel label="PNL CURVE // {pnlSeries.length} SESSIONS">
  ...
  <div class="spark-stats">
    <div class="spark-stat">
      <span class="muted">TODAY</span> <span class="pos">{stats.today}</span>
    </div>
    <div class="spark-stat">
      <span class="muted">TOTAL</span> <span class="pos">{stats.total}</span>
    </div>
    <div class="spark-stat">
      <span class="muted">MAX DD</span> <span class="neg">{stats.maxDd}</span>
    </div>
  </div>
</TuiPanel>
