...
<style>
  .t-topbar {
    ...
    padding: 0 0.75rem;
    height: var(--tui-topbar-height, 2.4rem);
    flex-shrink: 0;
    background: var(--tui-topbar-bg, #1e0938);
    border-bottom: 1px solid var(--tui-topbar-border, rgba(160, 60, 240, 0.4));
    box-shadow: var(--tui-topbar-shadow, 0 2px 20px rgba(120, 20, 200, 0.22));
    white-space: nowrap;
    overflow: hidden;
  }
  .t-topbar-l,
