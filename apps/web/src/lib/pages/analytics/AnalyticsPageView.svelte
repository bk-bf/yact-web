    ...
    <section class="analytics-params">
        <div class="params-grid">
            ...
            <label class="param-field">
                ...
                <input type="number" min="1" max="200" bind:value={paramTopN} class="param-input" />
            </label>
            <label class="param-field">
                <span class="param-label">Min trades</span>
                <input type="number" min="1" bind:value={paramMinTrades} class="param-input" />
            </label>
            <label class="param-field">
                <span class="param-label">F&G exit above</span>
                <input type="number" min="0" max="100" bind:value={paramFgExitAbove} class="param-input" />
            </label>
            <label class="param-field">
            ...
            <label class="param-field">
                ...
                <input type="number" step="0.0001" min="0" bind:value={paramFees} class="param-input" />
            </label>
            <label class="param-field">
                <span class="param-label">Slippage</span>
                <input type="number" step="0.0001" min="0" bind:value={paramSlippage} class="param-input" />
            </label>
    ...
    {#if sweepResult}
        <section class="analytics-results">
            <div class="analytics-meta">
                ...
                <span>{sweepResult.metadata.start} – {sweepResult.metadata.end ?? 'today'}</span>
...
<style>
    ...
    .row-top {
        background: color-mix(in srgb, var(--tv-highlight, #b026ff) 6%, transparent);
    }
    ...
    .btn-interpret:not(:disabled):hover {
        background: color-mix(in srgb, var(--tv-highlight, #b026ff) 12%, transparent);
    }
